...
def ambient(biome):
    ...
    if chance < 2-luck:
        print("But then suddenly, you fell into the backrooms by accident, and get eaten by a smiler. Must be bad luck.")
        gamenotover = False
    elif chance > 17-(luck*2):
        print("But then suddenly, you manage to noclip out of the dungeon with ease. Must be good luck.")
        gamenotover = False
...
while gamenotover == True:
    ...
    if room == 1:
        ...
        if choice == "n":
            ...
            if luck == 0:
                print("Err- wait a second, you can... You grabbed a lucky token!")
                luck = 1
        else:
            defaultchoices()
    elif room == 5:
